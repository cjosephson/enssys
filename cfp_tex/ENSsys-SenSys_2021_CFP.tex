...
\vspace{-7.5em}
\secCap{Call for Tutorials, Demos, \& Pitches}
...
%
First, we invite ``mini-tutorials'' and demos from established energy
...
%
Mini-tutorials and demos should send a few-sentence abstract and their requirements to the Village Chairs directly.
%
Presenters of mini-tutorials and demos who wish to have an archival publication are welcome to submit a 2-3 page extended abstract, which will be included in the ENSsys proceedings.
